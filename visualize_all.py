"""
============================================================================
DTSKD 遗忘研究 — 完整可视化 (Publication-Ready)
============================================================================
...
def fig2_ours_detail():
    ...
    rows = load_metrics('experiments/forgetting_ours_s27')
    cm, ep = load_forgetting('experiments/forgetting_ours_s27')
    F = compute_forget_frac(cm)
...
if __name__ == '__main__':
    ...
    print("="*60)
    print("  fig1_main_comparison.png    — 主对比图 (遗忘+精度+Loss+汇总)")
    print("  fig2_ours_detail.png        — Ours 详细分析 (AF/Branch/Diversity)")
    print("  fig3_forgetting_rate.png    — 遗忘速率分析")
    print("  fig4_learning_dynamics.png  — 训练动态 (Gap/Schedule)")
