...
参考: 干净数据 forgetting_hist_s27 vs forgetting_ours_s27
"""
...
cm_hist_n = load_correct_matrix('experiments/noise20_hist_s27')
cm_ours_n = load_correct_matrix('experiments/noise20_ours_s27')
...
hist_val_n, hist_val_ep_n = get_best_val('experiments/noise20_hist_s27')
ours_val_n, ours_val_ep_n = get_best_val('experiments/noise20_ours_s27')
...
cm_hist_c = load_correct_matrix('experiments/forgetting_hist_s27')
cm_ours_c = load_correct_matrix('experiments/forgetting_ours_s27')
hist_val_c, hist_val_ep_c = get_best_val('experiments/forgetting_hist_s27')
ours_val_c, ours_val_ep_c = get_best_val('experiments/forgetting_ours_s27')
...
for exp_dir, label, color, ls in [
    ('experiments/forgetting_hist_s27', 'HistKD clean', C['histkd'], '-'),
    ('experiments/forgetting_ours_s27', 'Ours clean', C['ours'], '-'),
    ('experiments/noise20_hist_s27', 'HistKD 20% noise', C['histkd'], '--'),
    ('experiments/noise20_ours_s27', 'Ours 20% noise', C['ours'], '--'),
]:
...
for exp_h, exp_o, label, color in [
    ('experiments/forgetting_hist_s27', 'experiments/forgetting_ours_s27', 'Clean', C['clean']),
    ('experiments/noise20_hist_s27', 'experiments/noise20_ours_s27', '20% Noise', C['noise']),
]:
